    ...
    >
      ...
      <div>
        ...
        <div className="bg-[#F7F7F7] rounded-[16px] md:rounded-[24px] p-4 md:pl-[42px] md:pr-[77.7px] md:pt-[61px] md:pb-[70.63px] flex flex-col md:flex-row items-center md:items-end justify-between gap-4 md:gap-0">
          <div>
            <h3 className="max-w-[294px] font-franklin font-semibold text-[18px] md:text-[24px] leading-[120%] tracking-[-3%] text-ink mb-1">
        ...
        <div className="mt-[16px] md:mt-[32px] flex flex-col md:flex-row items-center gap-[16px] md:gap-[24px] justify-center">
          <div className="bg-[#F7F7F7] rounded-[16px] md:rounded-[24px] flex flex-col gap-[20px] md:gap-[41.67px] p-4 md:px-[42px] md:pt-[30px] md:pb-[28px]">
            <figure className="self-end">
              <img
                src="/images/join.png"
                draggable={false}
            ...
            <div>
              ...
              <p className="max-w-[294px] text-[#5C5C5C] font-normal text-[14px] md:text-[16px] leading-[120%] tracking-[-2%]">
          ...
          <div className="bg-[#F7F7F7] rounded-[16px] md:rounded-[24px] flex flex-col gap-[20px] md:gap-[41.67px] p-4 md:px-[42px] md:pt-[30px] md:pb-[28px]">
            ...
            <div>
              <h3 className="max-w-[308px] font-franklin font-semibold text-[18px] md:text-[24px] leading-[120%] tracking-[-3%] text-ink mb-1">
                ExBuy, sell, or pick up with zero hassle.
              </h3>
              <p className="max-w-[308px] text-[#5C5C5C] font-normal text-[14px] md:text-[16px] leading-[120%] tracking-[-2%]">
